...
def train_model(model, traindataloader, valdataloader, criterion, device, optimizer, scheduler, num_epochs=50):
    ...
    for epoch in range(num_epochs):
        ...
        print('Epoch {}/{}: Learning Rate: {:.8f}; Train Loss: {:.4f}, Train Acc: {:.4f}; Val Loss: {:.4f} Val Acc: {:.4f}'.
              format(epoch + 1, num_epochs, optimizer.param_groups[0]['lr'], train_loss_all[-1], train_acc_all[-1], val_loss_all[-1], val_acc_all[-1]))
